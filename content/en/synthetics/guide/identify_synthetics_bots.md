---
title: Identify Synthetic Monitoring Bots
kind: documentation
...
`Sec-Datadog: Request sent by a Datadog Synthetic API Test (https://docs.datadoghq.com/synthetics/) - public_id: <SYNTHETICS_TEST_PUBLIC_ID>`
...
`Sec-Datadog: Request sent by a Datadog Synthetic Browser Test (https://docs.datadoghq.com/synthetics/) - public_id: <SYNTHETICS_TEST_PUBLIC_ID>`
