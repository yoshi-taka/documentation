...
|---------------------------------------------|-----------------------------------|------------------------------------------------------------------|-----------------------------------------|
| JIT Compiler bug on Linux/x64               | 2.0.x, 2.1.0-2.1.11, 2.2.0-2.2.5  | Set the environment variable `DD_CLR_DISABLE_OPTIMIZATIONS=true` | [DataDog/dd-trace-dotnet/issues/302][4] |
| Loading resources with a non `en-US` locale | 2.0.0                             | N/A                                                              | [dotnet/runtime/issues/23938][5]|
