...
|-----------------------------------------------|-----------------------------------|----------------------------------------------------------------------------------------------|-----------------------------------------|
| JIT Compiler bug on Linux/x64                 | 2.0.x, 2.1.0-2.1.11, 2.2.0-2.2.5  | Upgrade to latest patch, or set the environment variable `DD_CLR_DISABLE_OPTIMIZATIONS=true` | [DataDog/dd-trace-dotnet/issues/302][4] |
| Resource lookup bug with a non `en-US` locale | 2.0.0                             | Upgrade to latest patch                                                                      | [dotnet/runtime/issues/23938][5]        |
